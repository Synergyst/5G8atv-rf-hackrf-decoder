...
./build/fpvdec --no-amp --lna 40 --vga 12 --rate 10e6 --gain manual --freq 5866270000 --enforce-clkin --resolution 640x480 --source hackrf --web-port 9090 --gui web --lpf 2.4e6 --dev 2e6 --bits 8
